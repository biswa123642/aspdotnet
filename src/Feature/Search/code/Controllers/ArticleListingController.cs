...
namespace CGP.Feature.Search.Controllers
{
    ...
    public class ArticleListingController : StandardController
    {
        private readonly IArticleSearchRepository _articleSearchRepository;
        private readonly ISiteConfiguration _siteConfiguration;
        public ArticleListingController(IArticleSearchRepository articleSearchRepository, ISiteConfiguration siteConfiguration)
        {
            this._articleSearchRepository = articleSearchRepository;
            this._siteConfiguration = siteConfiguration;
        }
        public ActionResult GetArticleList()
        {
            return PartialView("~/Views/OneWeb/Search/ArticleList.cshtml", this.GetModel());
        }
        ...
        protected override object GetModel()
        {
            ...
            return _articleSearchRepository.GetArticleList(searchParameters);
        }
