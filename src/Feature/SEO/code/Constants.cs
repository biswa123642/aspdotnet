...
namespace CGP.Feature.SEO
{
    public static class Template
    {
        public static class Templates
        {
            ...
            public static readonly string ArticlePageTemplate = "{057AF325-C948-4918-A4E4-2C3F6CF04524}";
        }
    }
    ...
    public static class Constants
    {
        public static class SeoSchema
        {
            ...
            public const string ArticleSchema = "Article Schema";
            public const string ArticleTitle = "Title";
            public const string ArticleImage = "DesktopImage";
            public const string ArticlePublishedDate = "PublishDate";
            public const string ArticleAuthorName = "AuthorName";
            public const string BreadcrumbNavigationTitle = "NavigationTitle";
            public const string MetaDescription = "OpenGraphDescription";
            public const string ProductMediaList = "MediaList";
        }
    }
}