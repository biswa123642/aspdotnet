    ...
    public class ProductAttributeList : IComputedIndexField
    {
        ...
        public object ComputeFieldValue(IIndexable indexable)
        {
            ...
            if (indexableItem != null && indexableItem.TemplateID.ToString().Equals(Templates.ProductDetailPageIdString, StringComparison.OrdinalIgnoreCase))
            {
                ...
                IDictionary<string, IEnumerable<string>> attributeValues = productBaseItem == null || productBaseItem.ProductAttributes == null || !productBaseItem.ProductAttributes.Any() ? null : productBaseItem.ProductAttributes.AttributeValues;
