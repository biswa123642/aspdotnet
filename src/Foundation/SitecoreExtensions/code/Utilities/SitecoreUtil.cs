...
namespace CGP.Foundation.SitecoreExtensions.Utilities
{
    public static class SitecoreUtil
    {
        ...
        /// <summary>
        /// Get URL of media library item from media library item id
        /// </summary>
        /// <param name="MediaItemID"></param>
        /// <returns></returns>
        public static string GetImageUrlFromMediaLibraryItem(ID MediaItemID)
        {
            Sitecore.Data.Items.MediaItem media = new Sitecore.Data.Items.MediaItem(Sitecore.Context.Database.Items.GetItem(MediaItemID));
        ...
        public static string DictionaryValueByLanguage(string key, Language lang)
        {
        ...
        /// <returns></returns>
        public static string GetMediaItemUrl(MediaItem item)
        {
            if (item != null)
            {
